...
DP = read.csv(file = "data/raw/pilot-N24/DP.csv", header = T)
SD = read.csv(file = "data/raw/pilot-N24/SD.csv", header = T)
SP = read.csv(file = "data/raw/pilot-N24/SP.csv", header = T)

raw_data = rbind(DP,SD,SP)
raw_data<- raw_data %>% rename(Condition = randomiser.3q16,
...
raw_data <- raw_data %>% filter(Screen == "Testing")
...
## Results of N=24 Pilot Participants
